package com.example.vendingmachinemap.ui.screens.accountScreens.signUpScreen
...
@Composable
fun CreateAccountContent(viewModel: AccountViewModel) {
    ...
    Scaffold(
        topBar = {
            Row(
                ...
                IconButton(onClick = { viewModel.setState(AppStates.UiStates.Account.SignedOut) }) {
        ...
        Column(
            ...
            Button(
                onClick = { viewModel.createUser(userMail, userPass) },
                modifier = Modifier.fillMaxWidth()
            ) {
                Icon(
                ...
                Text("Valider et créer mon compte")
            }
        }
    }
}
